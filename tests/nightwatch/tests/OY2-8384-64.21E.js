...
module.exports={
    ...
    "Fill the 64.21E form, Update FPL changes, Save and Return to EnrollmentDataHome": function(browser){
        const tests_data={
            fpl:{
            ...
            total1:{
                ...
                selector: "/html/body/div/div/div[2]/div/div[3]/div/div[1]/div[2]/div/table/tbody/tr[4]/td[6]",
            },
        };
        browser.verify.containsText(tests_data.age0.selector, "Conception to birth");
      ...
      browser.click(tests_data.save.selector);
        ...
        browser.verify.containsText(tests_data.age1.selector, "Birth through age 12 months");
        browser.elements("xpath", "//*[@data-testid='textInput']", function(link_array) {
            link_array.value.forEach(function(element, index){
            let ele = element.ELEMENT;
            browser.elementIdEnabled(ele, function(result) {
      ...
      browser.verify.containsText(tests_data.age5.selector, "Age 1 year through age 5 years");
      browser.elements("xpath", "//*[@data-testid='textInput']", function(link_array) {
          link_array.value.forEach(function(element, index){
          let ele = element.ELEMENT;
          browser.elementIdEnabled(ele, function(result) {
    ...
    browser.verify.containsText(tests_data.age12.selector, "Age 6 years through age 12 years");
    browser.elements("xpath", "//*[@data-testid='textInput']", function(link_array) {
        link_array.value.forEach(function(element, index){
        let ele = element.ELEMENT;
        browser.elementIdEnabled(ele, function(result) {
  ...
  browser.verify.containsText(tests_data.age18.selector, "Age 13 years through age 18 years");
  browser.elements("xpath", "//*[@data-testid='textInput']", function(link_array) {
      link_array.value.forEach(function(element, index){
      let ele = element.ELEMENT;
      browser.elementIdEnabled(ele, function(result) {
