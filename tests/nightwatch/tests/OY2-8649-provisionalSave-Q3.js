    ...
    "Fill the 21PregnantWomen form and Save ": function(browser){
        const tests_data={
            ...
            status: {
                ...
                selector:"//*[contains(text(),'Provisional Data Certified and Submitted')]",
            },
            uncertify: {
       ...
       // browser.click(tests_data.save.selector);
        ...
        browser.verify.containsText(tests_data.provtext.selector, "You have submitted provisional SEDS data");
        browser.pause(timeout * 3);
        ...
        browser.verify.containsText(tests_data.provtext.selector, "Thank you for submitting your SEDS data!");
