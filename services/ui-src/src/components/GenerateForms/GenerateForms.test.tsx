...
import { generateQuarterForms as actualGenerateQuarterForms } from "../../libs/api";
...
const generateQuarterForms = vi.mocked(actualGenerateQuarterForms);
...
describe("Test GenerateForms.js", () => {
  ...
  it("should generate forms by sending a request to the API", () => {
    generateQuarterForms.mockResolvedValue({
      year: 2022,
      quarter: 2,
      status: 200,
      message: "success",
