...
import { buildSortedAccordionByYearQuarter as actualBuildSortedAccordionByYearQuarter } from "utility-functions/sortingFunctions";
...
const buildSortedAccordionByYearQuarter = vi.mocked(
  actualBuildSortedAccordionByYearQuarter
);
