...
const GridWithTotals = (props) => {
  ...
  const [gridTotalOfTotals, updateGridTotalOfTotals] = useState<any>();
  ...
  const updateRowTotals = () => {
    ...
    if (
      ...
      sum5Data.map((row) => {
        if (row !== undefined && props.questions) {
          let q1r1 = props.questions[0].rows[1] as Record<string, number>;
          let q4r1 = props.questions[3].rows[1] as Record<string, number>;

          let q1r2 = props.questions[0].rows[2] as Record<string, number>;
          let q4r2 = props.questions[3].rows[2] as Record<string, number>;

          let q1r3 = props.questions[0].rows[3] as Record<string, number>;
          let q4r3 = props.questions[3].rows[3] as Record<string, number>;
