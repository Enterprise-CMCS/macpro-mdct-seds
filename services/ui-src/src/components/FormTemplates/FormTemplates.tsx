...
const FormTemplates = () => {
  const [formYears, setFormYears] = React.useState<any>();
  const [selectedYear, setSelectedYear] = React.useState();
  const [inputYear, setInputYear] = React.useState<any>();
  const [currentTemplate, setCurrentTemplate] = React.useState<any>(false);
