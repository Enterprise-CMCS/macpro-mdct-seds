...
import {
  ...
  listTemplateYears as actualListTemplateYears,
  updateTemplate as actualUpdateTemplate,
} from "../../libs/api";
...
const listTemplateYears = vi.mocked(actualListTemplateYears);
const updateTemplate = vi.mocked(actualUpdateTemplate);
