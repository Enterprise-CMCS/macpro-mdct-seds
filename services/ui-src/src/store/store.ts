...
type StoreShape = {
  ...
  loadForm: (state, year, quarter, formName) => Promise<void>;
  updateAnswer: (gridAnswerData, questionId) => void;
  updateFpl: (newFpl) => void;
  wipeForm: () => void;
  updateFormStatus: (status_id) => void;
  updateSummaryNotes: (notes) => void;
