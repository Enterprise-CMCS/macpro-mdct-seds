...
export default {
  ...
  cognito: {
    ...
    USER_POOL_ENDPOINT: window._env_.COGNITO_USER_POOL_ENDPOINT,
    IDENTITY_POOL_ENDPOINT: window._env_.COGNITO_IDENTITY_POOL_ENDPOINT,
    OAUTH_ENABLED: window._env_.COGNITO_OAUTH_ENABLED !== "false",
