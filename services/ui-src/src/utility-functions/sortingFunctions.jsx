...
const dateFormatter = dateString => {
  ...
  try {
    // dateString will be an ISO string, like "2021-10-05T14:48:00.000Z"
    // Since it was generated by .toISOString(), it can be easily parsed.
    ...
    const amOrPm = part("dayPeriod");
    const zzz = part("timeZoneName");
